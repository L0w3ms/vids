...
$sql = "CREATE TABLE `vids`.`airlines` ( `airlinecode` VARCHAR(2) NOT NULL , `airlinename` TEXT NOT NULL , PRIMARY KEY (`airlinecode`)) ENGINE = InnoDB;";
...
$sql = "CREATE TABLE `vids`.`airports` ( `airportcode` VARCHAR(4) NOT NULL , `airportname` TEXT NOT NULL , PRIMARY KEY (`airportcode`)) ENGINE = InnoDB;";
...
$sql = "CREATE TABLE `vids`.`arrivals` ( `airlinecode` VARCHAR(2) NOT NULL , `flightno` INT(4) NOT NULL , `arrives` DATE NOT NULL , `arrivestime` TIME NOT NULL , `airport` VARCHAR(4) NOT NULL , `registration` VARCHAR(7) NULL DEFAULT NULL , `slottime` TIME NULL DEFAULT NULL , `eta` TIME NOT NULL , `bay` VARCHAR(5) NULL DEFAULT NULL , `gate` VARCHAR(5) NULL DEFAULT NULL , `aircraft` VARCHAR(8) NULL DEFAULT NULL , `belt` VARCHAR(5) NULL DEFAULT NULL , `type` VARCHAR(1) NOT NULL , `status` TEXT NOT NULL , `staffmsg` TEXT NOT NULL , PRIMARY KEY (`airlinecode`, `flightno`, `arrives`)) ENGINE = InnoDB;";
